...
export default function Login() {
    ...
    return (
        <div style={{ boxShadow: "0px 4px 10px 4px rgba(0, 0, 0, 0.05)" }} className='z-10 bg-white rounded-2xl p-8 w-[420px] flex flex-col justify-center items-center gap-4'>
            <h1 className='text-[#4E4E4E] font-lato-bold text-4xl'>Login</h1>
            <p className='text-[#787878] font-lato-light text-base'>Log in to your account and edit your notes.</p>
            <Formik
                initialValues={{
                    email: '',
                    password: '',
                ...
                {({ errors, touched }) => (
                    <Form className='py-6 w-full'>
                        ...
                        <div className='text-center'>
                            <button type="submit" className='login__btn mt-8 w-1/2 bg-[#FFB636] rounded h-[36px] text-white'>Register</button>
                        </div>
                    </Form>
                )}
            </Formik>
